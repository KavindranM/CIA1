...
render() {
  ...
  <div id="main-registration-container">
   <div id="register">
      <h3 className="Head">User Registration</h3>
      <form method="post"  name="userRegistrationForm"  onSubmit= {this.submituserRegistrationForm} >
      <label id="nam">Name</label>
      <br></br>
      <input type="text" name="username" placeholder="user name" value={this.state.fields.username} onChange={this.handleChange} />
      <div className="errorMsg">{this.state.errors.username}</div>
      <label>Email ID</label>
      <br></br>
      <input type="text" name="emailid" placeholder="emailid" value={this.state.fields.emailid} onChange={this.handleChange}  />
